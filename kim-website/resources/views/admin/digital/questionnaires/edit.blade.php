                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="type" class="form-select @error('type') is-invalid @enderror">
                                    <option value="siswa"
                                        {{ old('type', $questionnaire->type) == 'siswa' ? 'selected' : '' }}>CEKMA Siswa
                                    </option>
                                    <option value="mahasiswa"
                                        {{ old('type', $questionnaire->type) == 'mahasiswa' ? 'selected' : '' }}>CEKMA
                                        Mahasiswa</option>
                                    <option value="fresh_graduate"
                                        {{ old('type', $questionnaire->type) == 'fresh_graduate' ? 'selected' : '' }}>
                                        CEKMA Fresh Graduate</option>
                                    ...
                                    <option value="calon_asn"
                                        ...
                                        Calon ASN</option>
                                    <option value="umum"
                                        {{ old('type', $questionnaire->type) == 'umum' ? 'selected' : '' }}>CEKMA Umum
                                    </option>
                                </select>
                                @error('type')
                                <div class="invalid-feedback">{{ $message }}</div>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="alert alert-info">
                        ...
                        dan rencana aksi berdasarkan hasil cekma.
                    </div>
                    ...
                    <div class="form-check form-switch mb-4" style="display: flex; align-items: flex-start; gap: 15px;">
                        ...
                        <label class="form-check-label" for="aiEnabled" style="flex: 1;">
                            ...
                            <br><small class="text-muted">Hasil cekma akan dianalisis oleh AI untuk memberikan
        ...
        <div class="col-lg-4">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <small class="text-muted" style="display: block; margin-top: 10px;">CEKMA yang tidak aktif tidak
