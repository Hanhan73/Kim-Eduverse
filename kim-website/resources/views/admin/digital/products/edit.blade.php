        ...
        <div class="form-grid">
            ...
            <div class="form-sidebar">
                <div class="form-card">
                    ...
                    <div class="form-group">
                        ...
                        <select id="collaborator_id" name="collaborator_id">
                            ...
                            <option value="{{ $collaborator->id }}"
                                {{ old('collaborator_id', $product->collaborator_id ?? '') == $collaborator->id ? 'selected' : '' }}>
                                {{ $collaborator->name }} ({{ $collaborator->email }})
                            </option>
                            @endforeach
                        </select>
                        @error('collaborator_id')<span class="error">{{ $message }}</span>@enderror
                        <small>Pilih collaborator yang membuat konten ini (opsional)</small>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select id="type" name="type" required onchange="toggleProductTypeFields()">
                            ...
                            <option value="module"
                                {{ old('type', $product->type ?? '') == 'module' ? 'selected' : '' }}>Learning Module
                            </option>
                            <option value="ebook" {{ old('type', $product->type ?? '') == 'ebook' ? 'selected' : '' }}>
                                E-Book</option>
                            <option value="video" {{ old('type', $product->type ?? '') == 'video' ? 'selected' : '' }}>
                                Video Course</option>
                    ...
                    <div class="form-group" id="questionnaire-field" style="display: none;">
                        ...
                        <select id="questionnaire_id" name="questionnaire_id">
                            ...
                            <option value="{{ $q->id }}"
                                {{ old('questionnaire_id', $product->questionnaire_id ?? '') == $q->id ? 'selected' : '' }}>
                                {{ $q->name }}
                            </option>
                            @endforeach
                        </select>
                ...
                <div class="form-card">
                    ...
                    <div class="form-group">
                        ...
                        <div class="current-image">
                            <img src="{{ asset('images/' . $product->thumbnail) }}" alt="Current thumbnail">
                        </div>
                        @endif
                ...
                <div class="form-card">
                    ...
                    <div class="form-check">
                        <!-- Hidden input untuk is_featured -->
