        ...
        <form method="GET" action="{{ route('admin.digital.products.index') }}" class="filters-form">
            ...
            <div class="filter-group">
                <select name="type">
                    ...
                    <option value="questionnaire" {{ request('type') == 'questionnaire' ? 'selected' : '' }}>Questionnaire</option>
                ...
                <tr>
                    ...
                    <td>
                        <div class="action-buttons">
                            <a href="{{ route('admin.digital.products.edit', $product->id) }}" class="btn-icon btn-edit" title="Edit">
                                <i class="fas fa-edit"></i>
                            </a>
                            <form method="POST" action="{{ route('admin.digital.products.destroy', $product->id) }}" style="display: inline;" onsubmit="return confirm('Yakin ingin menghapus produk ini?')">
                                @csrf
                                @method('DELETE')
