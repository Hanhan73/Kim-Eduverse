...
<div style="max-width:800px;">
    <form method="POST"
        action="{{ isset($training) ? route('admin.digital.trainings.update', $training) : route('admin.digital.trainings.store') }}">
        @csrf
        ...
        <div class="card">
            <div class="card-header">
                <h3><i class="fas fa-info-circle"></i> Informasi Pelatihan</h3>
            </div>
            <div class="card-body">
                ...
                <div style="display:grid; grid-template-columns:1fr 1fr; gap:16px;">
                    <div class="form-group">
                        ...
                        <input type="date" name="training_date" class="form-control"
                            value="{{ old('training_date', isset($training) ? $training->training_date->format('Y-m-d') : '') }}"
                            required>
                    </div>
                    <div class="form-group">
                ...
                <div class="form-group" style="margin-top:4px;">
                    ...
                    <div style="display:flex; align-items:center; gap:12px;">
                        ...
                        <span style="color:#6b7280; font-size:0.875rem;">JP total keseluruhan pelatihan (akan tampil di
                            sertifikat)</span>
                    </div>
                </div>
            </div>
