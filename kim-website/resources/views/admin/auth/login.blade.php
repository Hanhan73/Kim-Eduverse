...
<head>
    ...
    <title>Admin Login - KIM EDUVERSE</title>
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="email" id="email" name="email"
                            class="form-control @error('email') is-invalid @enderror" placeholder="admin@kim.co.id"
                            value="{{ old('email', Cookie::get('admin_email')) }}" required autofocus>
                    </div>
                    @error('email')
