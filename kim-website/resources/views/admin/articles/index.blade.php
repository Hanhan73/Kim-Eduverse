        ...
        <aside class="sidebar">
            ...
            <div style="padding: 0 1.5rem 1rem; border-bottom: 1px solid rgba(255,255,255,0.1); margin-bottom: 1rem;">
                <div style="display: flex; align-items: center; gap: 12px; background: rgba(255,255,255,0.1); padding: 12px; border-radius: 10px;">
                    <div style="width: 40px; height: 40px; background: white; border-radius: 50%; display: flex; align-items: center; justify-content: center; color: #667eea; font-weight: 700; font-size: 1.2rem;">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="sidebar-item" style="margin-top: auto; padding-top: 1rem; border-top: 1px solid rgba(255,255,255,0.1);">
                    <form action="{{ route('admin.logout') }}" method="POST">
                        @csrf
                        <button type="submit" class="sidebar-link" style="width: 100%; background: none; border: none; cursor: pointer; text-align: left; color: white;">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('admin.articles.toggle-publish', $article) }}" method="POST" style="display: inline;">
                                    @csrf
                                    <button type="submit" class="badge {{ $article->is_published ? 'badge-published' : 'badge-draft' }}" style="border: none; cursor: pointer;">
                            ...
                            <td>
                                <div class="action-buttons">
                                    <a href="{{ route('admin.articles.edit', $article) }}" class="btn-icon edit" title="Edit">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <form action="{{ route('admin.articles.destroy', $article) }}" method="POST" style="display: inline;" onsubmit="return confirm('Yakin ingin menghapus artikel ini?')">
                                        @csrf
                                        @method('DELETE')
                        ...
                        <tr>
                            <td colspan="7" style="text-align: center; padding: 3rem; color: #718096;">
                                ...
                                Belum ada artikel. <a href="{{ route('admin.articles.create') }}" style="color: #667eea;">Buat artikel pertama</a>
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
