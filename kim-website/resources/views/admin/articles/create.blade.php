...
<body>
            ...
            <form action="{{ route('admin.articles.store') }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="form-container">
                    <div class="form-header">
                        ...
                        <p>Isi form di bawah untuk membuat artikel baru</p>
                    </div>
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group full-width">
                                ...
                                <input type="text" id="title" name="title"
                                    ...
                                    placeholder="Masukkan judul artikel yang menarik" value="{{ old('title') }}"
                                    required>
                                @error('title')
                                <span class="error-text">{{ $message }}</span>
                                @enderror
                                <span class="form-help">Judul akan otomatis menjadi URL (slug)</span>
                            </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="author" name="author" class="form-control"
                                        placeholder="Nama penulis (opsional)" value="{{ old('author', 'Admin') }}">
                                    <span class="form-help">Default: Admin</span>
                                </div>
                            </div>
                            ...
                            <div class="form-group full-width">
                                ...
                                <textarea id="excerpt" name="excerpt"
                                    ...
                                    placeholder="Tulis ringkasan singkat artikel (maks 500 karakter)" maxlength="500"
                            ...
                            <div class="form-group full-width">
                                ...
                                <span class="form-help">
                                    ...
                                    Gunakan HTML untuk formatting (bold, italic, list, dll)
                                </span>
                            </div>
    ...
    if (excerptField) {
        excerptField.addEventListener('input', function() {
            ...
            if (this.value.length > 450) {
                excerptCount.style.color = '#e53e3e';
            } else {
                excerptCount.style.color = '#718096';
            }
        });
    ...
    const autoSaveFields = ['title', 'category', 'excerpt', 'content', 'author'];

    autoSaveFields.forEach(fieldName => {
        const field = document.getElementById(fieldName);
        if (field) {
            // Load from localStorage
            const saved = localStorage.getItem('draft_' + fieldName);
    ...
    // Warn before leaving if form is filled
