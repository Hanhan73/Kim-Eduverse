...
<section class="org-structure">
    <div class="container">
        <div class="section-header">
            ...
            <h2 class="section-title">Struktur Perusahaan</h2>
            <p class="section-subtitle">
                Organisasi yang solid dengan pembagian peran yang jelas
            </p>
        </div>
        ...
        <div class="org-chart">
            ...
            <div class="org-level level-1">
                <div class="org-box ceo-box">
                    <div class="org-icon">
                        <i class="fas fa-crown"></i>
                    </div>
                    <div class="org-title">Chief Executive Officer</div>
                    <div class="org-name">Dr. Ahmad Wijaya, MBA</div>
                </div>
            </div>
            ...
            <div class="org-level level-2">
                <div class="org-box cto-box">
                    ...
                    <div class="org-name">Budi Santoso, M.Kom</div>
                </div>

                <div class="org-box coo-box">
                    <div class="org-icon">
                        <i class="fas fa-chart-line"></i>
                    </div>
                    <div class="org-title">Chief Operating Officer</div>
                    <div class="org-name">Siti Nurhaliza, MBA</div>
                </div>
                ...
                <div class="org-box cfo-box">
                    ...
                    <div class="org-name">Andi Pratama, SE., Ak</div>
                </div>
            </div>
            ...
            <div class="org-level level-3">
                <div class="org-box dept-box">
                    <div class="org-icon small">
                        <i class="fas fa-handshake"></i>
                    </div>
                    <div class="org-title small">Consultant Division</div>
                </div>
                ...
                <div class="org-box dept-box">
                    ...
                    <div class="org-title small">Developer Division</div>
                </div>
                ...
                <div class="org-box dept-box">
                    ...
                    <div class="org-title small">Edutech Division</div>
                </div>
                ...
                <div class="org-box dept-box">
                    ...
                    <div class="org-title small">HR & Admin</div>
                </div>
                ...
                <div class="org-box dept-box">
                    ...
                    <div class="org-title small">Marketing</div>
                </div>
            </div>
        </div>
    </div>
