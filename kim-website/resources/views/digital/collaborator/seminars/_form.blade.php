        ...
        <div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    @if(isset($seminar))
                    <a href="{{ route('digital.collaborator.seminars.show', $seminar) }}"
                        class="btn btn-secondary btn-block">
                        <i class="fas fa-eye"></i> Lihat Detail
                    </a>
                    @endif

                    <a href="{{ route('digital.collaborator.seminars.index') }}" class="btn btn-secondary btn-block">
...
<div id="quizModal" class="modal" style="display: none;">
    <div class="modal-content" style="max-width: 800px;">
        ...
        <form id="quizForm" action="{{ route('digital.collaborator.seminars.quizzes.store') }}" method="POST">
            @csrf
