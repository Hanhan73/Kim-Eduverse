...
<body>
    ...
    <div class="loading-overlay" id="loadingOverlay">
        ...
        <div class="loading-subtext">Mohon tunggu, AI sedang menganalisis hasil cekma kamu</div>
    </div>
    ...
    <div class="questionnaire-container">
        ...
        <div class="questionnaire-body">
            ...
            <!-- Form -->
            <form action="{{ route('digital.questionnaire.submit', $response->id) }}" method="POST"
                ...
                <div class="question-card" data-question-id="{{ $question->id }}"
                    ...
                    <div class="options-list">
                        ...
                        <div class="option-item" onclick="selectOption(this)">
                            <input type="radio" id="q{{ $question->id }}_{{ $value }}"
                                name="answers[{{ $question->id }}]" value="{{ $value }}" required>
        ...
        <div class="questionnaire-footer">
            <p>© {{ date('Y') }} <a href="{{ url('/') }}">KIM Eduverse</a> — Psikologi • Pendidikan • Digital Assessment
            </p>
        </div>
    </div>
