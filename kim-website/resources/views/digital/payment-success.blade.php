    ...
    <div class="success-container">
        <div class="success-card">
            ...
            <div class="success-header">
                <img src="{{ asset('images/logo.png') }}" alt="Success Icon" class="success-icon">
            ...
            <div class="success-body">
                ...
                <div class="pending-notice">
                    ...
                    <a href="{{ route('digital.payment.success', $order->order_number) }}" class="btn btn-warning"
...
======================================== --}}
                ...
                {{-- ========================================
                        SECTION: SEMINAR ACCESS
                    ======================================== --}}

                @if($hasSeminar)
                <div class="action-section" style="background: #f0f9ff; border-color: #90cdf4;">
                    <h3><i class="fas fa-video" style="color: #3182ce;"></i> Akses Seminar</h3>
                    <p>Selamat! Anda telah terdaftar dalam seminar. Klik tombol di bawah untuk mengakses konten seminar.
                    </p>

                    <a href="{{ route('digital.seminar.learn', $order->order_number) }}" class="btn btn-primary">
                        <i class="fas fa-play-circle"></i> Akses Seminar Sekarang
                    </a>
                </div>
                @endif
                {{-- ========================================
