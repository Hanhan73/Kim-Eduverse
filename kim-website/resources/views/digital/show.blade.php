...
<div class="product-detail">
    ...
    <div class="breadcrumb">
        ...
        <span>/</span>
        <a
            href="{{ route('digital.catalog', ['category' => $product->category->slug]) }}">{{ $product->category->name }}</a>
        <span>/</span>
    ...
    <div class="product-layout">
        ...
        <div class="product-info">
            ...
            <div class="cta-buttons">
                {{-- Tombol Lihat Detail - hanya muncul jika ada landing page aktif --}}
                @if($product->hasLandingPage())
                <a href="{{ route('digital.landing', $product->slug) }}" class="btn-promo">
