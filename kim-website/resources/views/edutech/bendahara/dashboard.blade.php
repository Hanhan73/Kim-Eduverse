...
<div class="main-content">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <small style="color: var(--gray);">{{ $withdrawal->instructor->email }}</small>
                        </td>
    ...
    <div class="content-section">
        <div class="section-header">
            <h2>Top Earning Instructors Bulan Ini</h2>
        </div>
        ...
        <div class="table-responsive">
            <table>
                ...
                <tbody>
                    @foreach($topInstructors as $index => $data)
                    <tr>
                        <td>
                            @if($index == 0)
        ...
        <div class="empty-state">
            ...
            <p>Data instruktur akan muncul setelah ada transaksi</p>
        </div>
        @endif
    </div>
</div>
