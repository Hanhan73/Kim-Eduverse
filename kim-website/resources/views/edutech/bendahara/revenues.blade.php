...
<div class="main-content">
    ...
    <div class="content-section">
        <form method="GET"
            ...
            @if(request()->hasAny(['period', 'instructor_id', 'start_date']))
            <div>
                <a href="{{ route('edutech.bendahara.revenue.index') }}" class="btn-secondary"
    ...
    <div class="stats-grid">
        ...
        <div class="stat-card">
            ...
            <div class="stat-content">
                <h3>Rp {{ number_format($stats['instructor_total'], 0, ',', '.') }}</h3>
                <p>Total Instructor Share (70%)</p>
    ...
    <div class="content-section">
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 20px;">
            ...
            <div
                ...
                <h4 style="margin: 0 0 10px 0; color: white;">Instructor (70% dari sisa)</h4>
                <h2 style="margin: 0; color: white;">Rp {{ number_format($stats['instructor_total'], 0, ',', '.') }}
                </h2>
                <small
                    style="opacity: 0.9;">{{ number_format(($stats['instructor_total'] / max($stats['total_revenue'], 1)) * 100, 1) }}%
                    dari total</small>
            </div>
            <div
    ...
    <div class="content-section">
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <strong>{{ $revenue->instructor->name }}</strong><br>
                            <small style="color: var(--gray);">{{ $revenue->instructor->email }}</small>
                        </td>
                        <td>
                            {{ $revenue->course->title }}<br>
        ...
        <div class="empty-state">
            ...
            <p>{{ request()->hasAny(['period', 'instructor_id']) ? 'Tidak ada data untuk filter yang dipilih' : 'Revenue dari transaksi akan muncul di sini' }}
            </p>
        </div>
        @endif
    </div>
...
function exportRevenue() {
    ...
    window.location.href = '{{ route("edutech.bendahara.revenue.index") }}?' + params.toString();
}
</script>
@endsection