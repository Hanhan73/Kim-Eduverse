                ...
                <div class="course-preview-card">
                    ...
                    <div class="preview-content">
                        ...
                        @auth
                            ...
                            @endif
                        @else
                            <a href="{{ route('login') }}" class="btn-enroll-large">
                        ...
                        <div class="course-includes">
                            ...
                            <ul>
                                <li><i class="fas fa-video"></i> {{ $course->materials->count() }} materi pembelajaran</li>
                ...
                <div class="tabs-content">
                    ...
                    <div class="tab-pane active" id="overview">
                        ...
                        <ul class="target-audience">
                            <li><i class="fas fa-user-graduate"></i> Pemula yang ingin memulai karir di {{ $course->category }}</li>
                            <li><i class="fas fa-user-tie"></i> Profesional yang ingin upgrade skill</li>
                            <li><i class="fas fa-users"></i> Siapa saja yang tertarik dengan {{ $course->category }}</li>
                        </ul>
                    </div>
                    ...
                    <div class="tab-pane" id="curriculum">
                        ...
                        <div class="curriculum-accordion">
                            @foreach($course->materials->groupBy(function($item) { return floor(($item->order - 1) / 5) + 1; }) as $section => $materials)
                        ...
                        <div class="quizzes-section">
                            ...
                            <div class="quiz-item">
                                ...
                                <div class="quiz-info">
                                    <h4>{{ $quiz->title }}</h4>
                                    <p>{{ $quiz->questions->count() }} soal • {{ $quiz->duration_minutes }} menit • Passing score: {{ $quiz->passing_score }}%</p>
                                </div>
                            </div>
                            @endforeach
                        </div>
                        ...
                        <div class="instructor-profile">
                            ...
                            <div class="instructor-stats">
                                ...
                                <div class="stat-box-instructor">
                                    <i class="fas fa-users"></i>
                                    <div>
                                        <div class="stat-num">{{ $course->instructor->coursesAsInstructor->sum(function($c) { return $c->enrollments->count(); }) }}</div>
                                ...
                                <div class="stat-box-instructor">
                                    ...
                                    <div>
                                        <div class="stat-num">{{ $course->instructor->coursesAsInstructor->count() }}</div>
                            ...
                            <div class="instructor-courses">
                                ...
                                <div class="courses-list-small">
                                    @foreach($course->instructor->coursesAsInstructor()->published()->where('id', '!=', $course->id)->take(3)->get() as $otherCourse)
                                    <a href="{{ route('edutech.courses.show', $otherCourse->slug) }}" class="course-item-small">
                                        <img src="{{ $otherCourse->thumbnail ?? 'https://via.placeholder.com/100x60' }}" alt="{{ $otherCourse->title }}">
                                        <div>
                ...
                <div class="sidebar-card">
                    ...
                    <div class="session-item">
                        ...
                        <div class="session-info">
                            <h4>{{ $session->title }}</h4>
                            <p>{{ $session->scheduled_at->format('H:i') }} WIB • {{ $session->duration_minutes }} menit</p>
                        </div>
                    </div>
                    @endforeach
                </div>
    ...
    <div class="container">
        ...
        <div class="related-grid">
            ...
            <div class="course-card-related">
                <a href="{{ route('edutech.courses.show', $related->slug) }}">
                    <img src="{{ $related->thumbnail ?? 'https://via.placeholder.com/300x180' }}" alt="{{ $related->title }}">
                </a>
                <div class="card-body-related">
                    <h3><a href="{{ route('edutech.courses.show', $related->slug) }}">{{ $related->title }}</a></h3>
