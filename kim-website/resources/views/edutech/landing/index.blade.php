...
<body>
        ...
        <div class="container">
            ...
            <div id="quizForm" class="quiz-form">
                ...
                <div class="quiz-navigation">
                    ...
                    <button id="submitBtn" onclick="getRecommendations()" class="btn btn-primary"
                        style="display: none;">
            ...
            <div class="courses-grid">
                ...
                <a href="{{ route('edutech.courses.detail', $course->slug) }}" class="course-card">
                    ...
                    <div style="padding: 25px;">
                        <span
                            style="display: inline-block; padding: 6px 14px; background: #e6f2ff; color: #4299e1; border-radius: 20px; font-size: 0.85rem; font-weight: 600; margin-bottom: 12px;">{{ $course->category }}</span>
    ...
    function resetQuiz() {
        currentStep = 0;
        document.querySelectorAll('input[type="radio"], input[type="checkbox"]').forEach(input => input.checked =
            false);
        document.querySelector('.quiz-step.active')?.classList.remove('active');
