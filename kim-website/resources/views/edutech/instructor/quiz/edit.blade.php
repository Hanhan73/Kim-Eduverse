...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .btn-add-option { background: var(--light); color: var(--dark); padding: 8px 16px; border-radius: 6px; font-size: 0.85rem; cursor: pointer; border: 2px dashed #e2e8f0; width: 100%; }
            ...
            <div class="card">
                ...
                <form action="{{ route('edutech.instructor.quiz.update', $quiz->id) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="max_attempts" class="form-control" value="{{ $quiz->max_attempts }}" min="1" max="10" required>
                    </div>
            ...
            <div class="question-list">
                ...
                <div class="question-item">
                    ...
                    <div class="question-options">
                        <div class="{{ $question->correct_answer === 'True' ? 'correct' : '' }}">
                            True @if($question->correct_answer === 'True')<i class="fas fa-check-circle"></i>@endif
                        </div>
                        <div class="{{ $question->correct_answer === 'False' ? 'correct' : '' }}">
                    ...
                    <div class="question-actions">
                        <button onclick="editQuestion({{ $question->id }})" class="btn btn-sm btn-edit">
                            <i class="fas fa-edit"></i> Edit
                        </button>
                        <form action="{{ route('edutech.instructor.quiz.questions.destroy', [$quiz->id, $question->id]) }}" method="POST" style="display: inline;" onsubmit="return confirm('Delete this question?')">
                            @csrf
                            @method('DELETE')
    ...
    <div id="questionModal" class="modal">
        <div class="modal-content">
            ...
            <form action="{{ route('edutech.instructor.quiz.questions.store', $quiz->id) }}" method="POST">
                ...
                <!-- Essay (no options) -->
                <div id="essayNote" style="display: none; background: #fffbeb; padding: 15px; border-radius: 8px; margin: 15px 0;">
