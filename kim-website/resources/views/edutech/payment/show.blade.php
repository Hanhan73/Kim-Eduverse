            ...
            <div class="payment-body">
                ...
                <div class="payment-methods">
                    ...
                    <div class="payment-info">
                        ...
                        <p>Setelah klik tombol "Bayar Sekarang", Anda akan diarahkan ke halaman pembayaran yang aman
                            dari Midtrans untuk menyelesaikan transaksi.</p>
                    </div>
                    ...
                    <div class="payment-logos">
                        <small style="color: var(--gray); width: 100%; margin-bottom: 10px;">Metode Pembayaran yang
                            Tersedia:</small>
                        <span style="color: var(--gray); font-size: 0.9rem;">Bank Transfer, Credit Card, GoPay, OVO,
                            Dana, ShopeePay</span>
                    </div>
                </div>
            </div>
