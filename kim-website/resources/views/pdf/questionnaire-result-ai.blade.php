    ...
    <div class="page">
        <div class="dimension-card">
            ...
            <div class="dimension-body">
                ...
                <!-- Score Info Box -->
                <div style="background: #f8fafc; border: 2px solid #e2e8f0; border-radius: 10px; padding: 10px 16px; margin-bottom: 12px; display: table; width: 100%;">
                    <div style="display: table-cell; width: 50%; vertical-align: middle;">
                        <div style="font-size: 8pt; color: #64748b; font-weight: 600; margin-bottom: 2px;">SKOR KAMU</div>
                        <div style="font-size: 16pt; color: #1e293b; font-weight: 800;">{{ $result['score'] ?? 0 }} <span style="font-size: 9pt; color: #94a3b8;">poin</span></div>
                    </div>
