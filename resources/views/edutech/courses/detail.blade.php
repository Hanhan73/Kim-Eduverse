        ...
        <div class="container">
            <div class="course-header-content">
                ...
                <div class="enrollment-card">
                    ...
                    @if($isInstructor)
                    <!-- Jika user adalah instructor -->
                    <a href="{{ route('edutech.instructor.courses.edit', $course->slug) }}"
                        class="btn-enroll instructor">
                        <i class="fas fa-edit"></i> Edit Kursus
                    </a>
                    @elseif($isEnrolled)
                    <!-- Jika sudah bayar (paid) -->
                    <a href="{{ route('edutech.courses.learn', $course->slug) }}" class="btn-enroll enrolled">
                        <i class="fas fa-play-circle"></i> Lanjutkan Belajar
                    </a>
                    @elseif($hasPendingPayment)
                    <!-- Jika sudah enroll tapi belum bayar (pending) -->
                    <div class="pending-payment-alert">
                        <i class="fas fa-exclamation-triangle"></i>
                        <p>Anda memiliki pembayaran yang belum diselesaikan</p>
                    </div>
                    <a href="{{ route('edutech.payment.show', $enrollment->id) }}" class="btn-enroll pending">
                        <i class="fas fa-credit-card"></i> Lanjutkan Pembayaran
                    </a>
                    <small class="pending-note">
                        <i class="fas fa-info-circle"></i>
                        Selesaikan pembayaran untuk mengakses course
                    </small>
                    @else
                    <!-- Belum enroll sama sekali -->
                            ...
                            <div class="module-item">
                                <div class="module-header">
                                    ...
                                    <div class="module-meta">
                                        <span><i class="fas fa-play-circle"></i> {{ $module->lessons->count() }}
                                            lessons</span>
