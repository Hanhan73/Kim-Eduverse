...
<div class="content-wrapper">
    ...
    <div style="margin-bottom: 30px;">
        ...
        <p style="color: var(--gray);">Configure your platform settings and preferences</p>
    </div>
    ...
    <div class="content-card">
        ...
        <div class="card-body">
            <form action="{{ route('edutech.admin.settings.update') }}" method="POST">
                ...
                <!-- General Information -->
                <div style="margin-bottom: 30px;">
                    <h4 style="color: var(--dark); font-size: 1.2rem; margin-bottom: 20px; padding-bottom: 10px; border-bottom: 2px solid var(--primary); display: flex; align-items: center; gap: 10px;">
                ...
                <div style="margin-bottom: 30px;">
                    ...
                    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 20px;">
                        <div>
                            ...
                            <input type="text" name="max_upload_size" value="{{ old('max_upload_size', $settings['max_upload_size'] ?? '2MB') }}"
                                style="width: 100%; padding: 12px 15px; border: 1px solid #e2e8f0; border-radius: 8px; font-size: 1rem;">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" name="default_course_price" value="{{ old('default_course_price', $settings['default_course_price'] ?? 0) }}" min="0"
                                style="width: 100%; padding: 12px 15px; border: 1px solid #e2e8f0; border-radius: 8px; font-size: 1rem;">
                        </div>
                    </div>
                    ...
                    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 20px; margin-top: 20px;">
                        <div style="display: flex; align-items: center; gap: 10px; padding: 12px; background: #f7fafc; border-radius: 8px;">
                            <input type="checkbox" name="enable_enrollment_approval" value="1" {{ ($settings['enable_enrollment_approval'] ?? false) ? 'checked' : '' }}
                                style="width: 20px; height: 20px; cursor: pointer;">
                            <span style="color: var(--dark); font-weight: 500;">Enable Enrollment Approval</span>
                        </div>

                        <div style="display: flex; align-items: center; gap: 10px; padding: 12px; background: #f7fafc; border-radius: 8px;">
                            <input type="checkbox" name="enable_certificates" value="1" {{ ($settings['enable_certificates'] ?? false) ? 'checked' : '' }}
                                style="width: 20px; height: 20px; cursor: pointer;">
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 25px; margin-top: 30px;">
        <div class="content-card">
            <div class="card-header">
                <h3><i class="fas fa-broom"></i> System Maintenance</h3>
            </div>
            <div class="card-body">
