            ...
            <div class="content-wrapper">
                <div class="content-display">
                    ...
                    <div class="alert alert-warning">
                        ...
                        <a href="{{ route('edutech.courses.learn', ['slug' => $course->slug, 'quiz' => $ongoingQuiz->quiz_id]) }}"
                    ...
                    @include('edutech.student.partials.quiz-result', ['attempt' => $resultAttempt])
                    ...
                    <!-- RESULT VIEW -->
                    @elseif($currentView === 'result' && $resultAttempt)
                    @include('edutech.student.partials.quiz-result', ['attempt' => $resultAttempt])
