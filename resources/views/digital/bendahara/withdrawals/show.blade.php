...
<div class="main-content">
    <div class="top-bar">
        ...
        <div class="user-info">
            <a href="{{ route('digital.bendahara.withdrawals.index') }}" class="btn-secondary">
    ...
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 25px; margin-bottom: 25px;">
        ...
        <div>
            <div class="content-section">
                ...
                <table style="width: 100%;">
                    <tr>
                        ...
                        <td style="padding: 12px 0;">{{ $withdrawal->collaborator->name }}</td>
                    </tr>
                    <tr>
                        <td style="padding: 12px 0; color: var(--dark); font-weight: 600;">Email</td>
                        <td style="padding: 12px 0;">{{ $withdrawal->collaborator->email }}</td>
                    </tr>
                    <tr>
            ...
            <div class="content-section" style="margin-top: 20px;">
                ...
                <form action="{{ route('digital.bendahara.withdrawals.approve', $withdrawal) }}" method="POST"
    ...
    <div class="content-section">
        <div class="section-header">
            <h2>10 Pendapatan Terakhir Collaborator</h2>
        </div>
        ...
        <div class="empty-state">
            ...
            <p>Pendapatan collaborator akan muncul di sini</p>
        </div>
        @endif
    </div>
</div>
...
<div id="rejectModal"
    ...
    <div
        ...
        <form action="{{ route('digital.bendahara.withdrawals.reject', $withdrawal) }}" method="POST">
            @csrf
