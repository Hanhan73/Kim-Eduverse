...
<div class="page-header">
    <div>
        <a href="{{ route('digital.collaborator.seminars.index') }}" class="btn btn-secondary">
            <i class="fas fa-arrow-left"></i> Kembali
        </a>
    </div>
    <div style="display: flex; gap: 10px;">
        <form action="{{ route('digital.collaborator.seminars.toggle-featured', $seminar) }}" method="POST"
        ...
        <a href="{{ route('digital.collaborator.seminars.edit', $seminar) }}" class="btn btn-primary">
...
<div style="display: grid; grid-template-columns: 2fr 1fr; gap: 25px;">
    ...
    <div>
        ...
        <div class="card">
            <div class="card-header">
                ...
                <a href="{{ route('digital.collaborator.seminars.enrollments', $seminar) }}" class="btn btn-sm btn-primary">
                    Lihat Semua
                </a>
            </div>
    ...
    <div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <a href="{{ route('digital.collaborator.seminars.enrollments', $seminar) }}" class="btn btn-primary btn-block">
                ...
                <form action="{{ route('digital.collaborator.seminars.toggle-active', $seminar) }}" method="POST">
                    @csrf
                    @method('PATCH')
                    <button type="submit"
