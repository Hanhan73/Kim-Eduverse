...
<body>
    <div class="admin-layout">
        ...
        <main class="main-content">
                ...
                <div class="form-container">
                    ...
                    <div class="form-body">
                        <div class="form-grid">
                            ...
                            <div class="form-group full-width">
                                <label for="excerpt" class="form-label">Ringkasan <span
                                        class="required">*</span></label>
                                <textarea id="excerpt" name="excerpt"
                                    class="form-control @error('excerpt') is-invalid @enderror" maxlength="500"
                            ...
                            <div class="form-group full-width">
                                ...
                                <div class="image-upload">
                                    ...
                                    <p style="color: #718096; font-size: 0.875rem; margin-top: 0.5rem;">Format: JPG,
                                        PNG, GIF (Maks 2MB)</p>
                                </div>
            ...
            <!-- Delete Form -->
            <form id="deleteForm" action="{{ route('admin.articles.destroy', $article) }}" method="POST"
                style="display: none;">
                @csrf
                @method('DELETE')
            </form>
